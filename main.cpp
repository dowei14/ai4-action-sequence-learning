...
public:
	...
	void start(const OdeHandle& odeHandle, const OsgHandle& osgHandle, GlobalData& global)
	{
		...
		playground->setPosition(osg::Vec3(0,0,0.0)); // playground positionieren und generieren
		...
		outer_playground->setPosition(osg::Vec3(0,0,0.0)); // playground positionieren und generieren
		...
		outer_playground2->setPosition(osg::Vec3(0,0,0.0)); // playground positionieren und generieren
		...
		double height = 0.9;
        	...
        	b1->setPose(osg::Matrix::rotate(0, 0,0, 1) * osg::Matrix::translate(-5,0,1.5) /* pose*/);
		Substance metal;
		metal.toMetal(1);
		b1->setSubstance(metal);
		...
		OdeRobot* vehicle3 = new FourWheeledRPosGripper(odeHandle, osgHandle, fconf);
